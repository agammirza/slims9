...
HTML;
            ...
            ?>
              ...
              <li class="nav-item dropdown <?= $menu_member_active; ?>">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                      ...
                      <a class="dropdown-item" href="index.php?p=member&logout=1">
                        <i class="fas fa-sign-out-alt mr-3"></i> <?= __('Logout'); ?></a>
                  </div>
              </li>
          ...
          <?php } else { ?>
            ...
            <!-- <li class="nav-item dropdown <?= $menu_member_active; ?>">
              ...
              <div class="dropdown-menu bg-primary dropdown-menu-lg-left" aria-labelledby="dropdownMenuButton">   
              <a class="dropdown-item text-white" href="index.php?p=member&sec=title_basket">Masuk</a>
              <a class="dropdown-item text-white" href="index.php?p=daftar_online">Daftar Online</a>
              </div>
            </li> -->

            <li class="nav-item <?= $menu_member_active; ?>">
                <a class="btn btn-success ripple-surface ms-2 me-1 text-white" href="index.php?p=member"><?= __('Member Area') ?></a>
                <!-- <a class="btn btn-primary ripple-surface ms-2 me-1 text-white" href="index.php?p=daftar_online">Daftar Online</a> -->
                <a class="btn btn-primary ripple-surface ms-2 me-1 text-white" href="index.php?p=login"><?= __('Login') ?></a>
                                  
                  <!-- <a class="nav-link" href="index.php?p=member"><?= __('Member Area')?></a> -->
                  <!-- <a class="nav-link" href="index.php?p=login"><?= __('Login') ?></a> -->
                  <!-- <button type="submit" class="btn btn-primary p-1"><a class="nav-link" href="index.php?p=login"><?= __('Login') ?></a></button> -->
            </li>
