...
<footer class="py-4 bg-grey-darkest text-grey-lighter" style="background-color: #003862">
    <div class="container">
        <div class="row py-4">
            <div class="col-md-3">
              <?php
            ...
            <div class="col-md-3 pt-8 md:pt-0">
                <h4 class="mb-4 text-warning"><?= __('About Us'); ?></h4>
                <p>
                    <?= $sysconf['template']['classic_footer_about_us']; ?>
                </p>
            </div>
            <div class="col-md-3 pt-8 md:pt-0">
                <h4 class="mb-4 text-warning"><?= __('Link Terkait'); ?></h4>
                <p>
                <ul class="list-reset">
                    <li><a class="text-light" href="https://www.perpusnas.go.id/" target="_blank"><?= __('Perpustakaan Nasional'); ?></a></li>
                    <li><a class="text-light" href="https://perpustakaan.kemdikbud.go.id/" target="_blank"><?= __('Perpustakaan Kemdikbud RI'); ?></a></li>
                    <li><a class="text-light" href="https://e-resources.perpusnas.go.id/"target="_blank"><?= __('E-Resources Perpustakaan Nasional'); ?></a></li> 
                    <li><a class="text-light" href="https://isbn.perpusnas.go.id/"target="_blank"><?= __('Layanan ISBN'); ?></a></li>
                    <li><a class="text-light" href="https://npp.pnri.go.id/"target="_blank"><?= __('Nomor Pokok Perpustakaan (NPP)'); ?></a></li>
                </ul>
                </p>
            </div>
            <div class="col-md-3 pt-8 md:pt-0">
                <h4 class="mb-4 text-warning"><?= __('Search'); ?></h4>
        ...
        <div class="flex font-thin text-sm">
            <p class="flex-1">&copy; <?php echo date('Y'); ?> &mdash; Senayan Developer</p>
